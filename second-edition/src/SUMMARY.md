...
- [Common Programming Concepts](ch03-00-common-programming-concepts.md)
    ...
    - [Comment Marchent les Fonctions](ch03-03-how-functions-work.md)
...
- [Utiliser des Structs pour Structurer des Données Connexes](ch05-00-structs.md)
    ...
    - [Syntaxe des Méthodes](ch05-03-method-syntax.md)

- [Enums et Pattern Matching](ch06-00-enums.md)
    - [Définir un Enum](ch06-01-defining-an-enum.md)
    - [The `match` Control Flow Operator](ch06-02-match.md)
    - [La Structure de Contrôle `match`](ch06-02-match.md)
    - [Une Structure de Contrôle plus concise : `if let`](ch06-03-if-let.md)

## Basic Rust Literacy

- [Modules](ch07-00-modules.md)
    - [`mod` et le Système de Fichiers](ch07-01-mod-and-the-filesystem.md)
    - [Contrôler la Visibilité avec `pub`](ch07-02-controlling-visibility-with-pub.md)
    - [Importer des Noms avec `use`](ch07-03-importing-names-with-use.md)
- [Types de Collections Courants](ch08-00-common-collections.md)
